...
?>
    ...
    <main class="container-fluid pb-5">
        ...
        <div class="row m-sm-1 mt-sm-0 m-lg-5 d-flex justify-content-center">
            ...
            <form action="assets\php\fichiers_php\enreg.php" method="POST" name="formulaire" id="document">
            ...
            ?>
                ...
                <!-- Carte Horizontale -->
                <div class="card col-lg-8 mt-3 mt-lg-0 mb-4 mb-lg-2 border-3 bordures rounded-5 mx-auto flex-lg-row">
